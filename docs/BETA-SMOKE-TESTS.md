...
| Focused ATM controls and layout regression | Inspect the title/minimap badge, native Condense and Expand controls, Settings footer, 10-pixel section gaps, layering, By Level scrollbar, and minimap rim placement. | Each focused control and layout behavior remains correct after the ATM rename. | 2026-09-21: User confirmed the focused ATM smoke checklist passed. | PASS |
