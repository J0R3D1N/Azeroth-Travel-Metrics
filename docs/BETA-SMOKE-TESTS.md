...
| Minimap launcher outside rim | At 80%, 100%, and 120% UI scale, inspect the sprint button at several saved angles, then drag it around the full minimap perimeter. | The launcher center remains outside the minimap rim at every angle and scale, including throughout the drag. | PENDING | PENDING |
