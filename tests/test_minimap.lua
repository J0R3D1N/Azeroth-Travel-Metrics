...
testlib.case("minimap default placement uses live dimensions", function()
    ...
    testlib.near(button.point[4], 116, 0.0001)
...
testlib.case("minimap placement falls back when dimensions are invalid", function()
    ...
    testlib.near(missingButton.point[5], 91, 0.0001)
end)
...
testlib.case("minimap shape lookup safely defaults to round", function()
    ...
    for _, options in ipairs(cases) do
        ...
        local button = harness.addon.Minimap.Create()
        testlib.near(button.point[4], 60.8112, 0.0001)
        testlib.near(button.point[5], 60.8112, 0.0001)
    end
end)
...
testlib.case("minimap live shape selects the current quadrant geometry", function()
    ...
    testlib.near(curvedHarness.addon.Minimap.button.point[4], -60.8112, 0.0001)
    testlib.near(curvedHarness.addon.Minimap.button.point[5], 60.8112, 0.0001)
    ...
    testlib.near(edgeHarness.addon.Minimap.button.point[4], 81.3137, 0.0001)
    testlib.near(edgeHarness.addon.Minimap.button.point[5], 81.3137, 0.0001)
end)
...
testlib.case("minimap create is idempotent native and interactive", function()
    ...
    testlib.near(first.point[4], 116, 0.0001)
    ...
    testlib.equal(background.height, 20)
    testlib.equal(background.point[1], "TOPLEFT")
    testlib.equal(background.point[2], first)
    testlib.equal(background.point[3], "TOPLEFT")
    ...
    testlib.equal(border.point[1], "TOPLEFT")
    testlib.equal(border.point[2], first)
    testlib.equal(border.point[3], "TOPLEFT")
...
testlib.case("minimap drag persists angle across recreation", function()
    ...
    testlib.near(recreatedButton.point[4], 81.3137, 0.0001)
    testlib.near(recreatedButton.point[5], 81.3137, 0.0001)
    testlib.near(
