...
testlib.case("ui theme creates character stat sections and assigns values", function()
    ...
    testlib.equal(section.title.textColor[2], 0.13)
    testlib.equal(section.title.textColor[3], 0.05)
    ...
    for index, row in ipairs(section.rows) do
        ...
        testlib.equal(row.background.atlas, nil)
        testlib.equal(row.label.textColor[1], 0.32)
        testlib.equal(row.label.textColor[2], 0.16)
        testlib.equal(row.label.textColor[3], 0.06)
        testlib.equal(row.value.textColor[1], 0.12)
        testlib.equal(row.value.textColor[2], 0.07)
        testlib.equal(row.value.textColor[3], 0.03)
...
testlib.case("ui theme creates an emphasized optional footer row", function()
    ...
    testlib.equal(section.footer.label.textColor[1], 0.24)
    testlib.equal(section.footer.label.textColor[2], 0.10)
    testlib.equal(section.footer.label.textColor[3], 0.02)
    testlib.equal(section.footer.label.textColor[4], 1)
    testlib.equal(section.footer.value.textColor[1], 0.24)
    testlib.equal(section.footer.value.textColor[2], 0.10)
    testlib.equal(section.footer.value.textColor[3], 0.02)
...
testlib.case("ui theme section keeps visible fallback shading", function()
    ...
    testlib.equal(section.divider.height, 1)
end)
